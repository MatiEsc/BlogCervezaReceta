...
from AppFinal.models import AmericanasAle, AlemanasChecasAustriacasAle, BelgasFrancesasAle, BritanicasAle, InternacionalesAle, AmericanasLager, AlemanasChecasAustriacasLager, InternacionalesLager, Otras
from AppFinal.forms import AmericanasAleFormulario, AlemanasChecasAustriacasAleFormulario, BelgasFrancesasAleFormulario, BritanicasAleFormulario, InternacionalesAleFormulario, AmericanasLagerFormulario, AlemanasChecasAustriacasLagerFormulario, InternacionalesLagerFormulario, OtrasFormulario
from django.contrib.auth.forms import AuthenticationForm, UserCreationForm
from django.contrib.auth import login, logout, authenticate
from django.contrib.auth.decorators import login_required 
from django.contrib.auth.hashers import make_password
from AppRegistro.views import login_request, register, editarPerfil, inicio, User, agregarAvatar, Avatar
